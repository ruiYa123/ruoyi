...
import com.ruoyi.business.service.IModelService;
...
public class ModelController extends BaseController
{
     ...
     * 查询模型列表
     */
    @PreAuthorize("@ss.hasPermi('business:model:list')")
    @GetMapping("/list")
     ...
     * 导出模型列表
     */
    @PreAuthorize("@ss.hasPermi('business:model:export')")
     ...
     * 获取模型详细信息
     */
    @PreAuthorize("@ss.hasPermi('business:model:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增模型
     */
    @PreAuthorize("@ss.hasPermi('business:model:add')")
     ...
     * 修改模型
     */
    @PreAuthorize("@ss.hasPermi('business:model:edit')")
     ...
     * 删除模型
     */
    @PreAuthorize("@ss.hasPermi('business:model:remove')")
